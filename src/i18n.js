...
export const EN = {
  ...
  "panel.emptyTimeline": "Nothing in the journal yet.",
  "panel.emptyChat": "No conversation yet. `perp chat` writes into this journal.",
  "panel.emptyDiff": "No changes in the working tree.",
  "panel.emptyBtw": "Nothing waiting.",
  "panel.emptyArtifacts": "None rendered. `perp artifact all` writes them.",
  "panel.notePlaceholder": "Leave a note for the loop…",
  "panel.send": "Send",
  "panel.sending": "Sending…",
  "panel.thinking": "thinking · {step}",
  "panel.bindingProblem": "binding",
  "panel.transcript": "transcript",
  "panel.interrupted": "interrupted",
  "panel.approveId": "Approve #{id}",
  "panel.fromSource": "from {source}",
  "panel.askPlaceholder": "Ask about this workspace…",
  "panel.asking": "Asking…",
  "panel.chatThinking": "thinking…",
  "panel.chatLimit": "Both sides go in the journal. Talking about a run cannot change it.",
  "panel.speakerOperator": "operator",
  "panel.speakerAssistant": "assistant",
  "reload.title": "Changed on disk",
  "reload.question": "{name} changed on disk, and you have unsaved edits. Load what is on disk and lose them?",
  "reload.discard": "Load from disk",
  "reload.keep": "Keep my edits",
  "panel.btwLimit": "An aside cannot approve, pause or redirect a run.",
  "harness.init": "Initialise Harness…",
  "harness.initTitle": "Initialise Harness",
  "harness.initConfirm": "Create a .harness folder in {path}?\n\nIt writes a binding, a requirements folder, a vision and a links file. Nothing existing is overwritten.",
  "harness.initDone": "Harness initialised.",
  "harness.requirements": "Requirements",
  "harness.noRequirements": "No requirements files",
  ...
  "harness.tab.requirements": "Requirements",
  ...
  "harness.hint.chat": "What was said, written by `perp chat`",
  "harness.hint.requirements": "Everything on the list, and its state",
  "harness.hint.approvals": "Waiting on a person",
  "harness.hint.diff": "What the working tree has changed",
  "harness.hint.btw": "Asides waiting to be picked up, and where to leave one",
  "harness.hint.artifacts": "Rendered from the journal",
  "harness.hint.refresh": "Re-read the journal now",
  "requirements.none": "This project's requirements source declares nothing yet.",
  "requirements.total": "{n} requirements",
  "requirements.full": "Read it in full",
  "requirements.placeholder": "What should it do?",
  "requirements.file": "File it",
  "requirements.note": "Files as {id}, with no marker. Only gates can mark work done.",
  "requirements.noPipe": "A requirement cannot contain `|` — it ends the table row it is written into.",
  ...
  "help.newVersion": "New Version…",
  "update.upToDate": "JustCode {version} is the newest version.",
  "update.available": "JustCode {latest} is out. You are running {current}. Download it now?",
  "update.download": "Download",
  "update.downloading": "Downloading {name}…",
  "update.installQuestion": "{name} has been downloaded. Install it now? JustCode closes so the installer can replace it.",
  "update.install": "Install",
  "update.reveal": "Show File",
  "update.noAsset": "Release {version} has no installer for this system.",
  "update.failed": "Could not fetch the new version. {error}",
  ...
  "lang.filterPlaceholder": "Select Language Mode",
  "lang.fileOf": "{name} file",
  "search.invalidRegex": "Invalid regex",
  "spell.notInDictionary": "“{word}” is not in the dictionary",
  "spell.didYouMean": "“{word}” — did you mean:",
  "error.openFile": "Could not open {path}",
  "error.saveFile": "Could not save {path}",
  "error.preview": "Could not preview {name}",
  "error.run": "Could not run {name}",
  "error.browser": "Could not open the browser",
  "error.show": "Could not show {name}",
  "error.openUrl": "Could not open {url}",
  "error.unsavedCheck": "Could not check for unsaved changes.",
  "error.closeWindow": "Could not close the window.",
  "run.needsPage": "Open or create an .html or .md file first — Run needs a page to show.",
  "clipboard.copyDenied": "Copy needs clipboard access, which the system declined.",
  "clipboard.pasteDenied": "Paste needs clipboard access, which the system declined.",
  ...
  "metrics.title": "Project Metrics",
  "metrics.rescan": "Rescan",
  ...
  "help.overviewPoint1":
    "Files open as tabs in one window; open a folder when you want one, but nothing has to be set up first.",
  "help.overviewPoint2": "Press F1 any time for the full keyboard shortcut reference.",

  "help.filesTitle": "Files",
  "help.filesIntro": "Files open as tabs, and File > Open Folder puts a whole folder in the Explorer beside them.",
  "help.filesPoint1":
  ...
  "sc.zoom": "Zoom",
  "sc.projectMetrics": "Open project metrics",
  ...
  "explorer.emptyHint": "Open a folder to browse its files.",
  "explorer.openFolder": "Open Folder",
  "explorer.refresh": "Refresh",
  "explorer.collapseAll": "Collapse All",
  "explorer.folderEmpty": "This folder is empty",
  "explorer.more": "{n} more…",
  "explorer.readError": "Could not read {path}",
  ...
  "explorer.binWindows": "Recycle Bin",
  "explorer.binMac": "Trash",
  "explorer.binLinux": "Trash",
  "explorer.deleteConfirm": "Move “{name}” to the {bin}?",
  "explorer.deleteConfirmMany": "Move {n} items to the {bin}?",
  "explorer.overwriteConfirm": "“{name}” already exists here. Replace it?",
  "explorer.createFailed": "Could not create {name}.",
  "explorer.renameFailed": "Could not rename {name}.",
  "explorer.deleteFailed": "Could not delete {name}.",
  "explorer.moveFailed": "Could not move {name}.",
  "explorer.copyFailed": "Could not copy {name}.",
  "explorer.nameEmpty": "A name is required.",
  "explorer.nameSeparator": "A name cannot contain \\ or /.",
  "explorer.nameInvalidChars": "A name cannot contain any of these: {chars}",
  "explorer.nameReserved": "“{name}” is a name Windows reserves for a device.",
  "explorer.nameTrailing": "A name cannot end with a space or a dot.",
  "explorer.nameExists": "“{name}” already exists in this folder.",
  "explorer.hiddenFile": "Hidden",
  "explorer.ignoredFile": "Ignored by Git",
  ...
  "help.explorerIntro": "Open a folder and its files appear in a tree beside the editor.",
  "help.explorerPoint1": "File → Open Folder (Ctrl+K Ctrl+O) opens a folder; View → Explorer (Ctrl+Shift+E) shows and hides the tree.",
  "help.explorerPoint2": "Arrow keys walk the tree, Enter opens a file, F2 renames and Delete moves to the Recycle Bin. Typing jumps to a name.",
  "help.explorerPoint3": "Right-click for new files and folders, cut, copy, paste, duplicate and rename. Drag to move, or hold Ctrl to copy.",
  "help.explorerPoint4": "Hidden files and files Git ignores are shown greyed rather than hidden, so nothing in the folder is invisible.",
};
