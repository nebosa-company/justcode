...
export const EN = {
  ...
  "harness.timeline": "Timeline — every step, newest first",
  "harness.chat": "Chat — the conversation, and a note to the loop",
  "harness.approvals": "Approvals — waiting on a person",
  "harness.diff": "Diff — what the working tree has changed",
  "harness.btw": "/btw — asides waiting to be picked up",
  "harness.artifacts": "Artifacts — rendered from the journal",
